...
class WindowMain:
    def __init__(self):
        ...
        ui_button_next_turn = ComponentButton(
            Rect(150, 5, 140, 40),
            'Next turn'
        )
        ui_button_next_turn.add_listener_click(self.on_click_next_turn)   
        self.ui_components.append(ui_button_next_turn)

        ui_button_statistics = ComponentButton(
            Rect(295, 5, 140, 40),
            'Statistics'
        )
        ui_button_statistics.add_listener_click(self.on_click_statistics)   
        self.ui_components.append(ui_button_statistics)

        """
        ui_button_statistics_text = ComponentButton(
            Rect(295, 5, 140, 80),
            'Test'
        )
        ui_button_statistics.add_listener_click()
        self.ui_components.append(ui_button_statistics_text)
        """
        ...
        self.game_controller = ControllerGame.instance()

        self.new_game()

    def new_game(self):
        self.game_controller.new_game()
        self.game = self.game_controller.game
    ...
    def on_click_next_turn(self, button):
        self.game_controller.make_tribe_move()

    def on_click_statistics(self, button):
        pass
    ...
    def on_click_create_actor(self, button: ComponentButton):
        self.game_controller.create_actor(self.selected_building.position, self.selected_building.tribe, button.linked_enum)
